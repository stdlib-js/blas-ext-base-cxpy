...
tape( 'the function has an arity of 5', function test( t ) {
	t.strictEqual( cxpy.length, 5, 'has expected arity' );
	t.end();
});

tape( 'the function adds elements of `x` to the corresponding elements of `y` and assigns the results to `y`', function test( t ) {
	var expected;
	var x;
	var y;
